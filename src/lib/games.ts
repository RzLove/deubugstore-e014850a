...
export const games: Game[] = [
  ...
  },
  {
    ...
    cover: "https://shared.cloudflare.steamstatic.com/store_apps/2322010/header.jpg",
    description: "Kratos e Atreus embarcam em uma jornada épica em busca de respostas antes do Ragnarök.",
    platform: "PC",
    minRequirements: "OS: Windows 10, Processador: i5-4670K, Memória: 8GB RAM, Placa de vídeo: GTX 1060",
    recommendedRequirements: "OS: Windows 11, Processador: i7-9700, Memória: 16GB RAM, Placa de vídeo: RTX 3060",
    delivery: "Envio instantâneo via e-mail.",
    trailer: "EE-4GvjKcfs",
  },
  {
    ...
    cover: "https://shared.cloudflare.steamstatic.com/store_apps/2651280/header.jpg",
    description: "Peter Parker e Miles Morales unem forças contra Venom em uma Nova York maior que nunca.",
    platform: "PC",
    minRequirements: "OS: Windows 10, Processador: i5-8400, Memória: 16GB RAM, Placa de vídeo: GTX 1650",
    recommendedRequirements: "OS: Windows 11, Processador: i7-12700, Memória: 16GB RAM, Placa de vídeo: RTX 3070",
    delivery: "Ativação direta na sua conta.",
    trailer: "qWa9DnUWjhI",
  },
];

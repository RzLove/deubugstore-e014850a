        ...
        {games.map((game) => (
          ...
          >
            ...
            <div className="relative aspect-[16/9] w-full overflow-hidden">
              ...
              <div className="absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-black/40 backdrop-blur-sm text-white">
                <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm.012 18.001c-3.151 0-5.706-2.553-5.706-5.704 0-.491.066-.967.186-1.42l3.414 1.417c.071 2.327 1.954 4.204 4.288 4.269l-2.182 1.438zm4.437-3.328c-.063 2.336-1.944 4.215-4.28 4.282l2.179-1.436c1.619-.107 2.91-1.396 3.019-3.013l1.437 2.179c-.066 2.336-1.946 4.215-4.281 4.282l2.179-1.436c1.619-.107 2.91-1.396 3.019-3.013l1.437 2.179c-.066 2.336-1.946 4.215-4.281 4.282l2.179-1.436c1.619-.107 2.91-1.396 3.019-3.013l1.437 2.179zM12 4.195c4.305 0 7.805 3.5 7.805 7.805s-3.5 7.805-7.805 7.805-7.805-3.5-7.805-7.805 3.5-7.805 7.805-7.805z" />
                </svg>
              </div>
